...
namespace Packaging.Utility
{
    internal class CustomMessageBox
    {
        ...
        public static DialogResult ShowMsg(string msg, MsgType msgType)
        {
            switch (msgType)
            {
                case MsgType.Ok:
        ...
        public static System.Windows.Forms.DialogResult ShowMsgBox(string msg, string catpion, MsgType msgType)
        {
            ...
            {
                case MsgType.Ok:
                    return Show(msg, catpion, MessageBoxButtons.OK);
                case MsgType.Question:
        ...
        {
            return DevExpress.XtraEditors.XtraMessageBox.Show(text, "确认？", MessageBoxButtons.YesNo,MessageBoxIcon.Exclamation);
        }
