...
{
    public class DbReportStorageWebExtension: DevExpress.XtraReports.Web.Extensions.ReportStorageWebExtension
    {
        ...
        public override byte[] GetData(string url)
        {
            ...
            var reportData = PackingReportItemDal.GetByName(url);
            if (reportData != null)
        ...
        public override Dictionary<string, string> GetUrls()
        {
            ...
            return PackingReportItemDal.GetItems()
                .Select(x => x.Name)
        ...
        public override void SetData(XtraReport report, string url)
        {
            ...
            if (reportData == null)
            {
                reportData = new PackingReportItem
                {
                    Name = url,
                    DisplayName = url,
            ...
            PackingReportItemDal.Save(reportData);
        }
