package com.nodes.framework.manager.factory;

import com.nodes.common.constant.Constants;
import com.nodes.common.utils.AddressUtils;
import com.nodes.common.utils.LogUtils;
...
import com.nodes.project.monitor.logininfor.domain.Logininfor;
import com.nodes.project.monitor.logininfor.service.LogininforServiceImpl;
import com.nodes.project.monitor.online.domain.OnlineSession;
import com.nodes.project.monitor.online.domain.UserOnline;
import com.nodes.project.monitor.online.service.IUserOnlineService;
import com.nodes.project.monitor.operlog.domain.OperLog;
import com.nodes.project.monitor.operlog.service.IOperLogService;
...
public class AsyncFactory {
     ...
     * @return 任务task
     */
    public static Runnable recordOper(final OperLog operLog) {
        return () -> {
            // 远程查询操作地点
