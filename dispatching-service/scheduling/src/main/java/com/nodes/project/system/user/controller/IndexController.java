...
import com.nodes.common.utils.CookieUtils;
...
import com.nodes.project.system.menu.domain.Menu;
import com.nodes.project.system.menu.service.IMenuService;
...
public class IndexController extends BaseController {
    ...
    public String index(ModelMap mmap) {
        ...
        mmap.put("copyrightYear", nodesConfig.getCopyrightYear());
        mmap.put("demoEnabled", nodesConfig.isDemoEnabled());
    ...
    public String main(ModelMap mmap) {
        mmap.put("version", nodesConfig.getVersion());
        return "main";
    }
