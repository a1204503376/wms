...
@IonicPage()
@Component({
  selector: 'page-update-detail-order',
  templateUrl: 'update-detail-order.html',
})
export class UpdateDetailOrderPage {
  public result: any = {};
  public skulots: any = [];
  public callback: any;
  public skuPackageDetails: any;//包装管理集合
  public skuPackageDetailsItem: any = {};//包装管理选中
  public planQtyBak:number = 0;
  ...
  constructor(public navCtrl: NavController,
    ...
    public ngZone: NgZone
      ...
      if (Utils.isNotEmpty(this.navParams.get('result'))) {
        ...
        this.planQtyBak = this.result.unPlanQty;
      }
  ...
  change(value) {
    ...
    this.result.unPlanQty = value >= this.planQtyBak ? this.planQtyBak : value <= 0 ? 1 : value;
  }
  ionViewDidLoad() {
    let that = this;
