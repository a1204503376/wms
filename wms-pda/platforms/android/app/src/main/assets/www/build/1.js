...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ReplenishmenhomePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_Utils__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_DataBase_Model__ = __webpack_require__(361);
 ...
 */
var ReplenishmenhomePage = /** @class */ (function () {
    function ReplenishmenhomePage(navCtrl, navParams, modalController, appService, nativeService, barcodeService, events, ngZone) {
    ...
    ReplenishmenhomePage.prototype.ionViewWillEnter = function () {
        var _this = this;
        //事件注册（扫描结果接收）
        this.events.subscribe('barcode:scan', function (barcode, time) {
            ...
            if (bt == __WEBPACK_IMPORTED_MODULE_7__services_BarCodeService__["b" /* BarcodeType */].BoxCode) {
                _this.ngZone.run(function () {
                    ...
                    _this.scanViewIsModel();
                });
            }
        });
    };
    ReplenishmenhomePage.prototype.ionViewWillLeave = function () {
        __WEBPACK_IMPORTED_MODULE_8__services_AppGlobal__["a" /* AppGlobal */].removeSubscribe(this);
    };
    ReplenishmenhomePage.prototype.ionViewDidLoad = function () {
        this.fillScanModel();
    };
    ReplenishmenhomePage.prototype.scanModelChange = function (event) {
     ...
     * 箱码解析
     */
    ReplenishmenhomePage.prototype.scanViewIsModel = function () {
        var _this = this;
     ...
     * 根据物品编码获取物品明细
     */
    ReplenishmenhomePage.prototype.getSkuListByCode = function (model) {
        var _this = this;
        this.appService.httpRequest(__WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["b" /* Api */].stockInner + __WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["b" /* Api */].getSkuListByCode, __WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["f" /* Method */].Get, { skuCode: model.skucode, taskId: this.taskId }, __WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["e" /* ContenType */].Form, function (result) {
            if (result.data.length > 1) {
                _this.openAsnRecordModal(result.data);
            }
            else {
                var model_1 = _this.result.detailList.find(function (x) { return x.skuId == result.data[0].skuId; });
                if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isNotEmpty(model_1)) {
                    console.log(model_1);
                    _this.selectModel = model_1;
                    //界面初始化
                    _this.fillScanModel();
                }
                else {
                    _this.nativeService.showToast('当前条码没有在补货列表查询到数据');
                }
            }
        });
    };
    ...
    *查看物品明细
    */
    ReplenishmenhomePage.prototype.openAsnRecordModal = function (skuList) {
        var _this = this;
        var myModal = this.modalController.create('SkuListModal', {
            skuList: skuList,
        });
        myModal.onDidDismiss(function (data) {
            if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isNotEmpty(data)) {
                var model = _this.result.detailList.find(function (x) { return x.skuId == data.skuId; });
                if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isNotEmpty(model)) {
                    console.log(model);
                    _this.selectModel = model;
                    //界面初始化
                    _this.fillScanModel();
                }
                else {
     ...
     * 初始化构建扫描组件
     */
    ReplenishmenhomePage.prototype.fillScanModel = function () {
        var _this = this;
        this.IsShow = true;
        this.labelTypecom.ComponentFlag = true;
        this.labelTypecom.locCodeFlag = false;
        this.labelTypecom.qtyDisabled = false;
        var scanModel = new __WEBPACK_IMPORTED_MODULE_3__models_DataBase_Model__["a" /* ScanModel */]();
        ...
        scanModel.qty = '0';
        //批属性加载
        this.selectModel.skuLotValList.forEach(function (element, index) {
        ...
        this.selectModel.locationList.forEach(function (element) {
            _this.locList.push({
     ...
     */
    ReplenishmenhomePage.prototype.detailed = function (flag, result) {
        var _this = this;
        var myModal = this.modalController.create('ReplenishmenDetilePage', {
            result: result,
            replenIsFalg: flag //当前补货明细
        });
        //回调
        myModal.onDidDismiss(function (data) {
            if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isNotEmpty(data) && data != undefined) {
     ...
     * 提交补货信息
     */
    ReplenishmenhomePage.prototype.submitReplenishmen = function () {
        var _this = this;
        if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isEmpty(this.selectModel)) {
        ...
        //记录之前物品ID
        var nextSkuId = this.selectModel.skuId;
        this.appService.httpRequest(__WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["b" /* Api */].stockInner + __WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["b" /* Api */].submitReplenishmen, __WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["f" /* Method */].Post, params, __WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["e" /* ContenType */].Json, function (result) {
            _this.getReplenishmenInfo(nextSkuId);
        });
    };
    /**
   * 补货详情
   */
    ReplenishmenhomePage.prototype.getReplenishmenInfo = function (nextSkuId) {
        var _this = this;
        this.appService.httpRequest(__WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["b" /* Api */].stockInner + __WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["b" /* Api */].getReplenishmenInfo, __WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["f" /* Method */].Get, {
            ...
            if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isNotEmpty(result.data)) {
                //补货任务已完成  
                if (result.data.finish == result.data.total || __WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isEmpty(result.data.detailList)) {
                    _this.navCtrl.pop();
                }
                else {
                    _this.result = result.data;
                    var nextMode = _this.result.detailList.find(function (x) { return x.skuId == nextSkuId; });
                    if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isNotEmpty(nextMode)) {
                        _this.selectModel = nextMode;
                    }
                    else {
                        _this.selectModel = _this.result.detailList[0];
                    }
                    _this.fillScanModel();
                }
            }
    ...
    * 未完成的明细
    */
    ReplenishmenhomePage.prototype.noFinishDetailed = function () {
        this.detailed(false, this.result);
    };
    /**
     * 已完成补货数量
     */
    ReplenishmenhomePage.prototype.finishDetailed = function () {
        var _this = this;
        this.appService.httpRequest(__WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["b" /* Api */].stockInner + __WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["b" /* Api */].getUnfinishReplenishmenList, __WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["f" /* Method */].Get, {
            taskId: this.taskId
        }, __WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["e" /* ContenType */].Content, function (result) {
            if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isNotEmpty(result.data)) {
                var resultModel = {
                    finish: _this.result.finish,
                    total: _this.result.total,
                    detailList: result.data
                };
                _this.detailed(true, resultModel);
            }
            else {
                _this.nativeService.showToast('没有已完成的数据');
            }
        });
    };
    /**
     * 返回
     */
    ReplenishmenhomePage.prototype.exit = function () {
        if (this.IsShow) {
            this.navCtrl.pop();
        }
        else {
     ...
     * 提交
     */
    ReplenishmenhomePage.prototype.btnOk = function () {
        if (this.IsShow) {
            this.IsShow = false;
        }
        else {
    ...
    return ReplenishmenhomePage;
}());

//# sourceMappingURL=replenishmenhome.js.map
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReplenishmenhomePageModule", function() { return ReplenishmenhomePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__replenishmenhome__ = __webpack_require__(1363);
...
var ReplenishmenhomePageModule = /** @class */ (function () {
    function ReplenishmenhomePageModule() {
    }
    ReplenishmenhomePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__replenishmenhome__["a" /* ReplenishmenhomePage */],
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__replenishmenhome__["a" /* ReplenishmenhomePage */]),
                __WEBPACK_IMPORTED_MODULE_6__components_crumbs_crumbs_module__["a" /* CrumbsModule */]
            ],
            schemas: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["NO_ERRORS_SCHEMA"]]
        })
    ], ReplenishmenhomePageModule);
    return ReplenishmenhomePageModule;
}());

//# sourceMappingURL=replenishmenhome.module.js.map
