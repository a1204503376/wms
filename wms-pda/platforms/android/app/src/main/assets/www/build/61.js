...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CheckinhomePage; });
...
/**
 * Generated class for the CheckinhomePage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var CheckinhomePage = /** @class */ (function () {
    function CheckinhomePage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.menuRole = [];
    }
    CheckinhomePage.prototype.ionViewWillEnter = function () {
    ...
    CheckinhomePage.prototype.ionViewDidLoad = function () {
    };
    CheckinhomePage.prototype.expression = function (event) {
        this.navCtrl.push(event.path);
    };
    CheckinhomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-checkinhome',template:/*ion-inline-start:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\checkinhome\checkinhome.html"*/'<!--\n\n  Generated template for the HomePage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar color="wmscolor">\n\n    <ion-title>收货\n\n      <!-- <div class="title_f_name">(青啤五厂)</div> -->\n\n    </ion-title>\n\n  </ion-navbar>\n\n  <!-- <div class="title-bt">\n\n    <div class="factory">\n\n      <span>待完成任务：200</span>\n\n    </div>\n\n    <div class="centerdiv"></div>\n\n    \n\n    <div class="finish_task">\n\n      <span>已完成任务：200</span>\n\n    </div>\n\n  </div> -->\n\n  <!-- <div class="nav-tile clearfix">\n\n    <ul>\n\n      <li>首页</li>\n\n      <li>\n\n        <ion-icon class="iconfont  iconicon_arr_right"></ion-icon>\n\n      </li>\n\n      <li>收货</li>\n\n    </ul>\n\n  </div> -->\n\n  <div class="nav-tile"> \n\n    <crumbs></crumbs>\n\n  </div>\n\n</ion-header>\n\n<ion-content>\n\n  <div class="login_content">\n\n    <ion-row>\n\n      <ion-col col-4 *ngFor="let item of menuRole; let _i = index">\n\n        <div  *ngIf="item.source!=\'\'" class="logon_ionic" (click)="expression(item)">\n\n          <ion-icon class="{{item.source}}"></ion-icon>\n\n          <span>{{item.name}}</span>\n\n        </div>\n\n      </ion-col>\n\n    </ion-row>\n\n  </div>\n\n</ion-content>'/*ion-inline-end:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\checkinhome\checkinhome.html"*/,
        }),
...
//# sourceMappingURL=checkinhome.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CheckinhomePageModule", function() { return CheckinhomePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__checkinhome__ = __webpack_require__(1006);
...
var CheckinhomePageModule = /** @class */ (function () {
    function CheckinhomePageModule() {
    }
    CheckinhomePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__checkinhome__["a" /* CheckinhomePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__checkinhome__["a" /* CheckinhomePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_crumbs_crumbs_module__["a" /* CrumbsModule */]
            ],
            schemas: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["NO_ERRORS_SCHEMA"]]
        })
    ], CheckinhomePageModule);
    return CheckinhomePageModule;
}());

//# sourceMappingURL=checkinhome.module.js.map
