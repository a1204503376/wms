...
var StockdetailPage = /** @class */ (function () {
    function StockdetailPage(navCtrl, navParams, nativeService) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.nativeService = nativeService;
        if (__WEBPACK_IMPORTED_MODULE_3__services_Utils__["a" /* Utils */].isNotEmpty(this.navParams.get('stockVO'))) {
    ...
    StockdetailPage.prototype.expression = function () {
    };
    StockdetailPage.prototype.detailed = function () {
    };
    StockdetailPage.prototype.scrollToTop = function () {
        setTimeout(function () {
    ...
    StockdetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-stockdetail',template:/*ion-inline-start:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\stockhome\stockdetail\stockdetail.html"*/'<ion-header>\n\n    <ion-navbar color="wmscolor">\n\n        <ion-title (click)="expression()">\n\n            库存查询\n\n            <!-- <div class="title_f_name">(青啤五厂)</div> -->\n\n        </ion-title>\n\n        <ion-buttons end (click)="detailed()">\n\n            <button ion-button icon-only>\n\n                <ion-icon name="menu"></ion-icon>\n\n            </button>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n    <div class="title-bt">\n\n        <div class="nav-tile">\n\n            <!-- <ul>\n\n                <li>首页</li>\n\n                <li>\n\n                    <ion-icon class="iconfont icon-arr-right"></ion-icon>\n\n                </li>\n\n                <li>库存</li>\n\n                <li>\n\n                    <ion-icon class="iconfont icon-arr-right"></ion-icon>\n\n                </li>\n\n                <li>库存查询</li>\n\n            </ul> -->\n\n            <crumbs></crumbs>\n\n        </div>\n\n    </div>\n\n</ion-header>\n\n<ion-content>\n\n    <div class="title-ms clearfix">\n\n        <div class="title-ms-info">\n\n            <ul>\n\n                <li class="l-width2">\n\n                    <span class="bold title s-text">{{stockVO.sku.skuName}}</span>\n\n                </li>\n\n                <li class="l-width1">\n\n                    <span class="s-label">规格：</span>\n\n                    <span class="s-text">{{stockVO.skuPackageVO.spec}}</span>\n\n                </li>\n\n                <li class="l-width1"><span class="s-right s-text">{{stockVO.warehouse.whName}}</span></li>\n\n                <li class="l-width1">\n\n                    <span class="s-label">库位：</span>\n\n                    <span class="s-text">{{stockVO.location.locCode}}</span>\n\n                </li>\n\n                <li class="l-width1">\n\n                    <span class="bold cyan s-label">总量：</span>\n\n                    <span class="bold orange s-text">{{stockVO.stockQty}}</span>\n\n                </li>\n\n                <li class="l-width1">\n\n                    <span class="s-label">容器：</span>\n\n                    <span class="s-text">{{stockVO.lpnCode}}</span>\n\n                </li>\n\n                <li class="l-width1">\n\n                    <span class="s-label">可用量：</span>\n\n                    <span class="s-text">{{stockVO.availableQty}}</span>\n\n                </li>\n\n                <li class="l-width2">\n\n                    <span class="s-label">货主：</span>\n\n                    <span class="s-text">{{stockVO.ownerName}}</span>\n\n                </li>\n\n            </ul>\n\n        </div>\n\n    </div>\n\n    <div class="list_item">\n\n        <ion-item *ngFor="let serial of serialList;">\n\n            <ion-input type="text" value="serial.serialNumber"></ion-input>\n\n        </ion-item>\n\n    </div>\n\n</ion-content>'/*ion-inline-end:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\stockhome\stockdetail\stockdetail.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__stockdetail__ = __webpack_require__(1045);
...
var StockdetailPageModule = /** @class */ (function () {
    ...
    StockdetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__stockdetail__["a" /* StockdetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__stockdetail__["a" /* StockdetailPage */]),
...
//# sourceMappingURL=stockdetail.module.js.map
