...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SettingThemePage; });
...
var SettingThemePage = /** @class */ (function () {
    function SettingThemePage(navCtrl, navParams, platform, appService, nativeService) {
    ...
    // 颜色选择器中事件，传递出来的值。
    SettingThemePage.prototype.colorPickerFun = function (colorType) {
        window.document.documentElement.setAttribute('data-theme', colorType);
    };
    SettingThemePage.prototype.btnOk = function () {
    };
    /**
       * 返回
       */
    SettingThemePage.prototype.back = function () {
        this.navCtrl.pop();
    };
    SettingThemePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-settingtheme',template:/*ion-inline-start:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\setting\settingtheme\settingtheme.html"*/'<ion-header>\n\n    <ion-navbar color="wmscolor">\n\n        <ion-title>主题颜色\n\n            <!-- <div class="title_f_name">(青啤五厂)</div> -->\n\n        </ion-title>\n\n    </ion-navbar>\n\n    <div class="nav-tile">\n\n        <!-- <ul>\n\n            <li>首页</li>\n\n            <li>\n\n                <ion-icon class="iconfont iconicon_arr_right"></ion-icon>\n\n            </li>\n\n            <li>个人设置</li>\n\n            <li>\n\n                <ion-icon class="iconfont iconicon_arr_right"></ion-icon>\n\n            </li>\n\n            <li>主题颜色</li>\n\n        </ul> -->\n\n        <crumbs></crumbs>\n\n    </div>\n\n</ion-header>\n\n<ion-content>\n\n    <button ion-button (click)="colorPickerFun(\'primary\')" color="default" width>默认</button>\n\n    <button ion-button (click)="colorPickerFun(\'red\')" color="red">红色</button>\n\n    <button ion-button (click)="colorPickerFun(\'orange\')" color="orange">橙色</button>\n\n    <button ion-button (click)="colorPickerFun(\'yellow\')" color="yellow">黄色</button>\n\n    <button ion-button (click)="colorPickerFun(\'green\')" color="green">绿色</button>\n\n    <button ion-button (click)="colorPickerFun(\'cyan\')" color="cyan">青色</button>\n\n    <button ion-button (click)="colorPickerFun(\'blue\')" color="blue">蓝色</button>\n\n    <button ion-button (click)="colorPickerFun(\'purple\')" color="purple">紫色</button>\n\n</ion-content>\n\n<ion-footer>\n\n    <div class="btn-box">\n\n        <button ion-button block class="btn-l" (click)="back()">\n\n            返回[Esc]\n\n        </button>\n\n    </div>\n\n</ion-footer>'/*ion-inline-end:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\setting\settingtheme\settingtheme.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_3__services_App_service__["a" /* AppService */],
            __WEBPACK_IMPORTED_MODULE_2__services_NativeService__["a" /* NativeService */]])
    ], SettingThemePage);
    return SettingThemePage;
}());

//# sourceMappingURL=settingtheme.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SettingThemePageModule", function() { return SettingThemePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__settingtheme__ = __webpack_require__(1041);
...
var SettingThemePageModule = /** @class */ (function () {
    function SettingThemePageModule() {
    }
    SettingThemePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__settingtheme__["a" /* SettingThemePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__settingtheme__["a" /* SettingThemePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_crumbs_crumbs_module__["a" /* CrumbsModule */]
                //ColorPickerModule
            ],
            schemas: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["NO_ERRORS_SCHEMA"]]
        })
    ], SettingThemePageModule);
    return SettingThemePageModule;
}());

//# sourceMappingURL=settingtheme.module.js.map
