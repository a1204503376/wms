...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SearchOrderPage; });
...
var SearchOrderPage = /** @class */ (function () {
    function SearchOrderPage(navCtrl, navParams, appService, nativeService, events, barCodeService, ngZone) {
    ...
    SearchOrderPage.prototype.ionViewDidEnter = function () {
        this.asnBillNo = '';
    };
    SearchOrderPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        //事件注册（扫描结果接收）
    ...
    SearchOrderPage.prototype.onClick = function (record) {
        this.asnBillNo = record.asnBillNo;
        this.navCtrl.push('CheckOrderPage', { result: this.asnBillNo });
    };
    SearchOrderPage.prototype.getContainerList = function () {
        var _this = this;
    ...
    SearchOrderPage.prototype.resetPage = function () {
        this.records = [];
    ...
    SearchOrderPage.prototype.loadData = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.getContainerList();
    };
    SearchOrderPage.prototype.toggleFun = function () {
        console.log(this.asnBillNo);
    };
    SearchOrderPage.prototype.ionViewWillLeave = function () {
        __WEBPACK_IMPORTED_MODULE_7__services_AppGlobal__["a" /* AppGlobal */].removeSubscribe(this);
    };
    /**
     * 数据解析
     */
    SearchOrderPage.prototype.analysisDate = function (barcode) {
        var _this = this;
    ...
    * 入库单回车事件
    */
    SearchOrderPage.prototype.keyEnter = function (event) {
     ...
     * 获取入库单详情
     */
    SearchOrderPage.prototype.headerInfoForBox = function () {
        var _this = this;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__search_order__ = __webpack_require__(1010);
...
var SearchOrderPageModule = /** @class */ (function () {
    ...
    SearchOrderPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__search_order__["a" /* SearchOrderPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__search_order__["a" /* SearchOrderPage */]),
...
//# sourceMappingURL=search-order.module.js.map
