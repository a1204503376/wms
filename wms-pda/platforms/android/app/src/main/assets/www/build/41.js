...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return moveStocks; });
...
/**
 * Generated class for the moveStocks page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var moveStocks = /** @class */ (function () {
    function moveStocks(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.recList = 0;
        this.stocksSelect = 0;
    }
    moveStocks = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-movestocks',template:/*ion-inline-start:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\movehome\movestocks\movestocks.html"*/'<ion-header>\n\n    <ion-navbar color="wmscolor">\n\n        <ion-title (click)="expression()">\n\n            多拖移动\n\n            <!-- <div class="title_f_name">(青啤五厂)</div> -->\n\n        </ion-title>\n\n        <ion-buttons end (click)="detailed()">\n\n            <button ion-button icon-only>\n\n                <ion-icon name="menu"></ion-icon>\n\n            </button>\n\n        </ion-buttons>\n\n    </ion-navbar>\n\n    <div class="title-bt">\n\n        <div class="order" *ngIf="stocksSelect==1&&recList==0">\n\n            <ion-item class="item-top">\n\n                <ion-input type="text" placeholder="库位"></ion-input>\n\n                <ion-avatar item-start>\n\n                    <ion-icon name="search"></ion-icon>\n\n                </ion-avatar>\n\n                <ion-avatar item-end (click)="setServerIp()">\n\n                    <ion-icon class="iconfont icon-saomiao"></ion-icon>\n\n                </ion-avatar>\n\n            </ion-item>\n\n        </div>\n\n        <div class="nav-tile">\n\n            <!-- <ul>\n\n                <li>首页</li>\n\n                <li>\n\n                    <ion-icon class="iconfont icon-arr-right"></ion-icon>\n\n                </li>\n\n                <li>移动</li>\n\n                <li>\n\n                    <ion-icon class="iconfont icon-arr-right"></ion-icon>\n\n                </li>\n\n                <li>多拖移动</li>\n\n            </ul> -->\n\n            <crumbs></crumbs>\n\n            <div class="order-info">公共库</div>\n\n        </div>\n\n    </div>\n\n</ion-header>\n\n<ion-content>\n\n    <div *ngIf="stocksSelect==0">\n\n        <div class="list_item">\n\n            <ion-item>\n\n                <ion-label>库 房：</ion-label>\n\n                <ion-input type="text"></ion-input>\n\n                <ion-select [(ngModel)]="gaming">\n\n                    <ion-option selected:disabled value="001">公共库</ion-option>\n\n                    <ion-option value="002">备件库</ion-option>\n\n                    <ion-option value="003">电机库</ion-option>\n\n                    <ion-option value="004">设备库</ion-option>\n\n                </ion-select>\n\n            </ion-item>\n\n        </div>\n\n    </div>\n\n    <div *ngIf="stocksSelect==1">\n\n        <div class="title-ms clearfix">\n\n            <div class="title-ms-info" *ngIf="recList==1">\n\n                <ul>\n\n                    <li class="l-width2">\n\n                        <span class="s-label">原库位：</span>\n\n                        <span class="s-text">LOC-01-01-001</span>\n\n                    </li>\n\n                </ul>\n\n            </div>\n\n        </div>\n\n        <div class="list_original" *ngIf="recList==0">\n\n            <ul>\n\n                <li class="l-width2">\n\n                    <span class="s-label">原容器：</span>\n\n                    <span class="s-text">LPN0000001</span>\n\n                </li>\n\n                <li class="l-width2">\n\n                    <span class="s-label">原容器：</span>\n\n                    <span class="s-text">LPN0000001</span>\n\n                </li>\n\n                <li class="l-width2">\n\n                    <span class="s-label">原容器：</span>\n\n                    <span class="s-text">LPN0000001</span>\n\n                </li>\n\n                <li class="l-width2">\n\n                    <span class="s-label">原容器：</span>\n\n                    <span class="s-text">LPN0000001</span>\n\n                </li>\n\n                <li class="l-width2">\n\n                    <span class="s-label">原容器：</span>\n\n                    <span class="s-text">LPN0000001</span>\n\n                </li>\n\n                <li class="l-width2">\n\n                    <span class="s-label">原容器：</span>\n\n                    <span class="s-text">LPN0000001</span>\n\n                </li>\n\n                <li class="l-width2">\n\n                    <span class="s-label">原容器：</span>\n\n                    <span class="s-text">LPN0000001</span>\n\n                </li>\n\n                <li class="l-width2">\n\n                    <span class="s-label">原容器：</span>\n\n                    <span class="s-text">LPN0000001</span>\n\n                </li>\n\n                <li class="l-width2">\n\n                    <span class="s-label">原容器：</span>\n\n                    <span class="s-text">LPN0000001</span>\n\n                </li>\n\n                <li class="l-width2">\n\n                    <span class="s-label">原容器：</span>\n\n                    <span class="s-text">LPN0000001</span>\n\n                </li>\n\n            </ul>\n\n        </div>\n\n        <div class="list_item" *ngIf="recList==1">\n\n            <ion-item>\n\n                <ion-label>目标库位：</ion-label>\n\n                <ion-input type="text"></ion-input>\n\n                <ion-avatar item-end (click)="setServerIp()">\n\n                    <ion-icon class="iconfont icon-saomiao"></ion-icon>\n\n                </ion-avatar>\n\n            </ion-item>\n\n        </div>\n\n    </div>\n\n</ion-content>\n\n<ion-footer>\n\n    <div class="btn-box">\n\n        <button ion-button block class="btn-l" (click)="btnOk()">\n\n            返回[Esc]\n\n        </button>\n\n        <button ion-button block class="btn-d" (click)="exit()">\n\n            提交[Ent]\n\n        </button>\n\n    </div>\n\n\n\n</ion-footer>'/*ion-inline-end:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\movehome\movestocks\movestocks.html"*/,
        }),
...
//# sourceMappingURL=movestocks.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "moveStocksModule", function() { return moveStocksModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__movestocks__ = __webpack_require__(1029);
...
var moveStocksModule = /** @class */ (function () {
    function moveStocksModule() {
    }
    moveStocksModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__movestocks__["a" /* moveStocks */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__movestocks__["a" /* moveStocks */]),
                __WEBPACK_IMPORTED_MODULE_3__components_crumbs_crumbs_module__["a" /* CrumbsModule */]
            ],
            schemas: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["NO_ERRORS_SCHEMA"]]
        })
    ], moveStocksModule);
    return moveStocksModule;
}());

//# sourceMappingURL=movestocks.module.js.map
