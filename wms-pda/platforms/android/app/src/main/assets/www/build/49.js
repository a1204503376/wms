...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CyclecountRecordPage; });
 ...
 */
var CyclecountRecordPage = /** @class */ (function () {
    function CyclecountRecordPage(navCtrl, navParams, appService) {
        ...
        this.size = 10; //数量
        this.records = [];
        if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isNotEmpty(this.navParams.get('countBillNo'))) {
            this.countBillNo = this.navParams.get('countBillNo');
            this.skuLotNum = Array(30).fill(0).map(function (x, i) { return i; });
        }
    }
    CyclecountRecordPage.prototype.range = function (item) {
        var arr = [];
        for (var i = 1; i <= 30; i++) {
     ...
     * 获取盘点记录
     */
    CyclecountRecordPage.prototype.getCountRecords = function (infiniteScroll) {
        var _this = this;
        var params = {
        ...
        this.appService.httpRequest(__WEBPACK_IMPORTED_MODULE_3__utils_appConstant__["b" /* Api */].StockCountPDA + __WEBPACK_IMPORTED_MODULE_3__utils_appConstant__["b" /* Api */].countRecords, __WEBPACK_IMPORTED_MODULE_3__utils_appConstant__["f" /* Method */].Get, params, '', function (result) {
    ...
    CyclecountRecordPage.prototype.doInfinite = function (infiniteScroll) {
        this.getCountRecords(infiniteScroll);
    };
    CyclecountRecordPage.prototype.ionViewDidLoad = function () {
        this.getCountRecords('');
    };
    CyclecountRecordPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-cyclecountrecord',template:/*ion-inline-start:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\cyclecounthome\cyclecountrecord\cyclecountrecord.html"*/'<!--\n\n  Generated template for the CyclecountPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar  color="wmscolor">\n\n    <ion-title>盘点记录</ion-title>\n\n  </ion-navbar>\n\n  <div class="nav-tile">\n\n    <crumbs></crumbs>\n\n  </div>\n\n</ion-header>\n\n\n\n<ion-content class="no-scroll">\n\n  <div *ngFor="let item of records; let _i = index" class="item-wrapper">\n\n    <div class="item-row">\n\n      <span>{{item.skuCode}}</span>\n\n      <span>{{item.locCode}}</span> \n\n    </div>\n\n    <div class="item-row">\n\n      <span>{{item.skuName}}</span>\n\n      <span><span style="color: orange;">{{item.countQty}}</span>{{item.wsuName}}</span>\n\n    </div>\n\n    <span>{{item.procTime}}</span> \n\n    <div *ngFor="let skuLot of range(item)">\n\n      <span>{{skuLot}}</span>\n\n    </div>\n\n  </div>\n\n\n\n  <ion-infinite-scroll (ionInfinite)="doInfinite($event)" threshold="100px">\n\n    <ion-infinite-scroll-content loadingSpinner="bubbles" loadingText="正在加载更多..."></ion-infinite-scroll-content>\n\n  </ion-infinite-scroll>\n\n</ion-content>'/*ion-inline-end:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\cyclecounthome\cyclecountrecord\cyclecountrecord.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_4__services_App_service__["a" /* AppService */]])
    ], CyclecountRecordPage);
    return CyclecountRecordPage;
}());

//# sourceMappingURL=cyclecountrecord.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CyclecountPageModule", function() { return CyclecountPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cyclecountrecord__ = __webpack_require__(1024);
...
var CyclecountPageModule = /** @class */ (function () {
    function CyclecountPageModule() {
    }
    CyclecountPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__cyclecountrecord__["a" /* CyclecountRecordPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__cyclecountrecord__["a" /* CyclecountRecordPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_crumbs_crumbs_module__["a" /* CrumbsModule */]
            ],
            schemas: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["NO_ERRORS_SCHEMA"]]
        })
    ], CyclecountPageModule);
    return CyclecountPageModule;
}());

//# sourceMappingURL=cyclecountrecord.module.js.map
