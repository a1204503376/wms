...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CougnyPage; });
 ...
 */
var CougnyPage = /** @class */ (function () {
    function CougnyPage(navCtrl, navParams, platform, statusBar, appService, storage, nativeService, app) {
    ...
    CougnyPage.prototype.ionViewWillEnter = function () {
        if (__WEBPACK_IMPORTED_MODULE_5__services_Utils__["a" /* Utils */].isNotEmpty(this.navParams.get('menuRole'))) {
    ...
    CougnyPage.prototype.expression = function (event) {
        this.navCtrl.push(event.path);
    };
    CougnyPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-cougny',template:/*ion-inline-start:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\cougny\cougny.html"*/'<ion-header>\n\n  <ion-navbar color="wmscolor">\n\n    <ion-title>库内\n\n    </ion-title>\n\n  </ion-navbar>\n\n  <div class="nav-tile"> \n\n    <crumbs></crumbs>\n\n  </div>\n\n</ion-header>\n\n<ion-content>\n\n  <div class="login_content">\n\n    <ion-row>\n\n      <ion-col col-4 *ngFor="let item of menuRole; let _i = index">\n\n        <div  *ngIf="item.source!=\'\'" class="logon_ionic" (click)="expression(item)">\n\n          <ion-icon class="{{item.source}}"></ion-icon>\n\n          <span>{{item.name}}</span>\n\n        </div>\n\n      </ion-col>\n\n    </ion-row>\n\n  </div>\n\n</ion-content>'/*ion-inline-end:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\cougny\cougny.html"*/,
        }),
...
//# sourceMappingURL=cougny.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CougnyPageModule", function() { return CougnyPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cougny__ = __webpack_require__(1016);
...
var CougnyPageModule = /** @class */ (function () {
    function CougnyPageModule() {
    }
    CougnyPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__cougny__["a" /* CougnyPage */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__cougny__["a" /* CougnyPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_crumbs_crumbs_module__["a" /* CrumbsModule */]
            ],
            schemas: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["NO_ERRORS_SCHEMA"]]
        })
    ], CougnyPageModule);
    return CougnyPageModule;
}());

//# sourceMappingURL=cougny.module.js.map
