...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_hiprint_hiprint_bundle_js__ = __webpack_require__(1033);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_printer__ = __webpack_require__(363);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_App_service__ = __webpack_require__(157);
...
var PrintingPage = /** @class */ (function () {
    function PrintingPage(navCtrl, navParams, printer, appService, nativeService) {
    ...
    PrintingPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad PrintingPage');
    };
    PrintingPage.prototype.btnOk = function () {
        var _this = this;
        if (__WEBPACK_IMPORTED_MODULE_4__services_Utils__["a" /* Utils */].isEmpty(this.whName)) {
            this.nativeService.showToast('库房名称不能为空');
            return;
        }
        if (__WEBPACK_IMPORTED_MODULE_4__services_Utils__["a" /* Utils */].isEmpty(this.zoneName)) {
        ...
        var printTemplateModel = {
            whName: this.whName,
            zoneName: this.zoneName,
            locCode: this.locCode
        };
        this.appService.httpRequest(__WEBPACK_IMPORTED_MODULE_6__utils_appConstant__["b" /* Api */].api + __WEBPACK_IMPORTED_MODULE_6__utils_appConstant__["b" /* Api */].printTemplateList, __WEBPACK_IMPORTED_MODULE_6__utils_appConstant__["f" /* Method */].Get, params, __WEBPACK_IMPORTED_MODULE_6__utils_appConstant__["e" /* ContenType */].Form, function (result) {
            var printTemplate = new __WEBPACK_IMPORTED_MODULE_2__assets_hiprint_hiprint_bundle_js__["a" /* hiprint */].PrintTemplate({
                template: JSON.parse(result.data[0].sptData)
            });
            var styleModel = '<style printstyle="">.hiprint-printPaper.hiprint-printPaper-content{position:relative;}</style>↵';
            styleModel += printTemplate.getHtml(printTemplateModel)[0].outerHTML;
            _this.printer.isAvailable().then(function (result) {
            }, function (result) {
            });
            var options = {
                name: 'MyDocument',
            ...
            _this.printer.print(styleModel, options).then(function (result) {
            }, function (result) {
                console.log(result);
                _this.nativeService.showToast('打印失败，请检查手持打印驱动是否安装');
            });
        });
    };
    PrintingPage.prototype.exit = function () {
        this.navCtrl.pop();
    };
    PrintingPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-printing',template:/*ion-inline-start:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\printing\printing.html"*/'<!--\n\n  Generated template for the PrintingPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>打印设置</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <ion-item>\n\n    <ion-label>库房名称：</ion-label>\n\n    <ion-input maxlength=\'30\' type="text" [(ngModel)]="whName"></ion-input>\n\n  </ion-item>\n\n  <ion-item>\n\n    <ion-label>库区名称：</ion-label>\n\n    <ion-input maxlength=\'30\' type="text" [(ngModel)]="zoneName"></ion-input>\n\n  </ion-item>\n\n  <ion-item>\n\n    <ion-label>库位名称：</ion-label>\n\n    <ion-input maxlength=\'30\' type="text" [(ngModel)]="locCode"></ion-input>\n\n  </ion-item>\n\n</ion-content>\n\n<ion-footer>\n\n  <div class="btn-box">\n\n    <button ion-button block class="btn-l" (click)="exit()">\n\n      返回[Esc]\n\n    </button>\n\n    <button ion-button block class="btn-d" (click)="btnOk()">\n\n      打印[Ent]\n\n    </button>\n\n  </div>\n\n\n\n</ion-footer>'/*ion-inline-end:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\printing\printing.html"*/,
        }),
...
/* harmony export (immutable) */ __webpack_exports__["a"] = hiprint;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__printing__ = __webpack_require__(1032);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PrintingPageModule = /** @class */ (function () {
    ...
    PrintingPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__printing__["a" /* PrintingPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__printing__["a" /* PrintingPage */]),
            ],
        })
    ], PrintingPageModule);
