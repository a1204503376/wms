...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TakeawayPage; });
 ...
 */
var TakeawayPage = /** @class */ (function () {
    function TakeawayPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    TakeawayPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad TakeawayPage');
    };
    TakeawayPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-takeaway',template:/*ion-inline-start:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\takeawayhome\takeawaypiece\takeaway\takeaway.html"*/'<ion-header >\n\n  <ion-navbar color="wmscolor">\n\n    <ion-title (click)="expression()">\n\n      按件拣货\n\n    </ion-title>\n\n    <ion-buttons start (click)="setServerIp()">\n\n      <button ion-button icon-only>\n\n        <ion-icon name="arrow-back"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-buttons end (click)="detailed()">\n\n      <button ion-button icon-only>\n\n        <ion-icon name="menu"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n  <div class="title-bt"> \n\n    <div class="order">\n\n     <div class="order-number">SO000000000001</div>\n\n     <div class="order-info">单据拣货进度 5/10</div>\n\n    </div>\n\n    <div class="nav-tile">\n\n     <!-- <ul>\n\n         <li>首页</li>\n\n         <li><ion-icon class="iconfont icon-arr-right"></ion-icon></li>\n\n         <li>拣货</li>\n\n         <li><ion-icon class="iconfont icon-arr-right"></ion-icon></li>\n\n         <li>按件拣货</li>\n\n         <li><ion-icon class="iconfont icon-arr-right"></ion-icon></li>\n\n         <li>执行拣货</li>\n\n     </ul> -->\n\n     <crumbs></crumbs>\n\n </div>\n\n  </div>\n\n</ion-header>\n\n<ion-content class="no-scroll">\n\n<div>哇哈哈大促促销装</div>\n\n  <div style="width: 45%;float: left;">\n\n    <div style="width: 100%;flex-wrap: nowrap;display: flex;">\n\n    <label >源 库 位:</label>\n\n    <label style="color: black;">1-10-100</label>\n\n    </div>\n\n    <div style="width: 100%;flex-wrap: nowrap;display: flex;">\n\n    <label >源 容 器:</label>\n\n    <label style="color: black;">LPN0000001</label>\n\n    </div>\n\n    <div style="width: 100%;flex-wrap: nowrap;display: flex;">\n\n    <label style="color: black;">批属性01</label>\n\n    </div>\n\n    <div style="width: 100%;flex-wrap: nowrap;display: flex;">\n\n    <label style="color: black;">批属性02</label>\n\n    </div>\n\n\n\n  </div>\n\n  <div style="width: 45%;float: left;">\n\n    <div style="width: 100%;flex-wrap: nowrap;display: flex;">\n\n    <label style="color: black;">SKU0000000000000001</label>\n\n    </div>\n\n    <div style="width: 100%;flex-wrap: nowrap;display: flex;">\n\n    <label >拣货规格：</label>\n\n    <label style="color: black;">1-10-100</label>\n\n    </div>\n\n    <div style="width: 100%;flex-wrap: nowrap;display: flex;">\n\n      已拣货: <span style="color: #F59A23;">20</span>/100\n\n    </div>\n\n\n\n  </div>\n\n  <div style="width: 10%;float:right;">\n\n    <ion-icon class="iconfont icon-arr-right"></ion-icon>\n\n  </div>\n\n</ion-content>\n\n<ion-footer>\n\n    <div class="btn-box">\n\n        <button ion-button block class="btn-l" (click)="btnOk()">\n\n            返回[Esc]\n\n          </button>\n\n          <button ion-button block class="btn-d"  (click)="exit()">\n\n            提交[Ent]\n\n          </button>\n\n    </div>\n\n\n\n</ion-footer>\n\n'/*ion-inline-end:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\takeawayhome\takeawaypiece\takeaway\takeaway.html"*/,
        }),
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TakeawayPageModule", function() { return TakeawayPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__takeaway__ = __webpack_require__(1051);
...
var TakeawayPageModule = /** @class */ (function () {
    function TakeawayPageModule() {
    }
    TakeawayPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__takeaway__["a" /* TakeawayPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__takeaway__["a" /* TakeawayPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_crumbs_crumbs_module__["a" /* CrumbsModule */]
            ],
            schemas: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["NO_ERRORS_SCHEMA"]]
        })
    ], TakeawayPageModule);
    return TakeawayPageModule;
}());

//# sourceMappingURL=takeaway.module.js.map
