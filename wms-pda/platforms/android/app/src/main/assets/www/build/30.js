...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return StockhomePage; });
 ...
 */
var StockhomePage = /** @class */ (function () {
    function StockhomePage(navCtrl, navParams, appService) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.appService = appService;
        this.menuRole = [];
    }
    StockhomePage.prototype.ionViewWillEnter = function () {
        if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isNotEmpty(this.navParams.get('menuRole'))) {
            ...
            if (this.menuRole.length < 15) {
                var count = 15 - this.menuRole.length;
    ...
    StockhomePage.prototype.expression = function (event) {
        this.navCtrl.push(event.path);
    };
    StockhomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-stockhome',template:/*ion-inline-start:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\stockhome\stockhome.html"*/'<!--\n\n  Generated template for the StockhomePage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n    <ion-navbar color="wmscolor">\n\n      <ion-title>库存\n\n        <!-- <div class="title_f_name">(青啤五厂)</div> -->\n\n      </ion-title>\n\n    </ion-navbar>\n\n    <!-- <div class="title-bt">\n\n      <div class="factory">\n\n        <span>待完成任务：200</span>\n\n      </div>\n\n  \n\n      <div class="centerdiv"></div>\n\n      <div class="finish_task">\n\n        <span>已完成任务：200</span>\n\n      </div>\n\n    </div> -->\n\n    <div class="nav-tile">\n\n      <!-- <ul>\n\n        <li>首页</li>\n\n        <li>\n\n          <ion-icon class="iconfont  iconicon_arr_right"></ion-icon>\n\n        </li>\n\n        <li>库存</li>\n\n      </ul> -->\n\n      <crumbs></crumbs>\n\n    </div>\n\n  </ion-header>\n\n  <ion-content>\n\n    <div class="login_content">\n\n      <ion-row>\n\n        <ion-col col-4 *ngFor="let item of menuRole; let _i = index">\n\n          <div *ngIf="item.source!=\'\'" class="logon_ionic" (click)="expression(item)">\n\n            <ion-icon class="{{item.source}}"></ion-icon>\n\n            <span>{{item.name}}</span>\n\n          </div>\n\n        </ion-col>\n\n      </ion-row>\n\n    </div>\n\n  </ion-content>'/*ion-inline-end:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\stockhome\stockhome.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__services_App_service__["a" /* AppService */]])
    ], StockhomePage);
    return StockhomePage;
}());

//# sourceMappingURL=stockhome.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StockhomePageModule", function() { return StockhomePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__stockhome__ = __webpack_require__(1046);
...
var StockhomePageModule = /** @class */ (function () {
    function StockhomePageModule() {
    }
    StockhomePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__stockhome__["a" /* StockhomePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__stockhome__["a" /* StockhomePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_crumbs_crumbs_module__["a" /* CrumbsModule */]
            ],
            schemas: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["NO_ERRORS_SCHEMA"]]
        })
    ], StockhomePageModule);
    return StockhomePageModule;
}());

//# sourceMappingURL=stockhome.module.js.map
