...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MergeTrayListPage; });
 ...
 */
var MergeTrayListPage = /** @class */ (function () {
    function MergeTrayListPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.isShow = true;
        this.resultList = this.navParams.get('result');
    }
    MergeTrayListPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad CollageTaskListPage');
    };
    /**
     * 选择托盘
     */
    MergeTrayListPage.prototype.lpnListOnClick = function (item) {
        if (this.isShow) {
    ...
    MergeTrayListPage.prototype.exit = function () {
        if (this.isShow) {
            this.navCtrl.pop();
        }
        else {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MergeTrayListPageModule", function() { return MergeTrayListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__merge_tray_list__ = __webpack_require__(1018);
...
var MergeTrayListPageModule = /** @class */ (function () {
    function MergeTrayListPageModule() {
    }
    MergeTrayListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__merge_tray_list__["a" /* MergeTrayListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__merge_tray_list__["a" /* MergeTrayListPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_crumbs_crumbs_module__["a" /* CrumbsModule */]
            ],
            schemas: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["NO_ERRORS_SCHEMA"]]
        })
    ], MergeTrayListPageModule);
    return MergeTrayListPageModule;
}());

//# sourceMappingURL=merge-tray-list.module.js.map
