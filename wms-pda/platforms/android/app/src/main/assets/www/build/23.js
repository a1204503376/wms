...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TakeawaypiecePage; });
 ...
 */
var TakeawaypiecePage = /** @class */ (function () {
    //页面实体
    function TakeawaypiecePage(navCtrl, navParams, nativeService, appService, events) {
    ...
    TakeawaypiecePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad TakeawaypiecePage');
    };
    TakeawaypiecePage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.wellenNo = "";
        //事件注册（扫描结果接收）
        this.events.subscribe('barcode:scan', function (barcode, time) {
            if (__WEBPACK_IMPORTED_MODULE_6__services_AppGlobal__["a" /* AppGlobal */].scanFlag) {
                ...
                _this.wellenNo = barcode;
                _this.getPickInfo();
            }
        });
    };
    TakeawaypiecePage.prototype.ionViewWillLeave = function () {
        __WEBPACK_IMPORTED_MODULE_6__services_AppGlobal__["a" /* AppGlobal */].removeSubscribe(this);
    };
    TakeawaypiecePage.prototype.itemInfo = function () {
        this.navCtrl.push('TakeawayinPage');
    };
    /**
  * 入库单回车事件
  */
    TakeawaypiecePage.prototype.keyEnter = function (event) {
        if (event && event.keyCode == 13) {
            this.getPickInfo();
        }
    };
    TakeawaypiecePage.prototype.getPickInfo = function () {
        var _this = this;
        if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isEmpty(this.wellenNo)) {
            this.nativeService.showToast('请输入波次编号');
            __WEBPACK_IMPORTED_MODULE_6__services_AppGlobal__["a" /* AppGlobal */].scanFlag = true;
            return;
        }
        var params = {
        ...
        this.appService.httpRequest(__WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["b" /* Api */].Outstock + __WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["b" /* Api */].getPickInfo, __WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["f" /* Method */].Get, params, __WEBPACK_IMPORTED_MODULE_5__utils_appConstant__["e" /* ContenType */].Form, function (result) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isEmpty(_this.pickPlansList)) {
                _this.nativeService.showToast('当前任务下没有物品');
                return;
            }
            //默认取第一条
            _this.pickPlansModel = _this.pickPlansList[0];
            if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isNotEmpty(_this.pickPlansModel)) {
                _this.navCtrl.push('TakeawayinPage', { pickPlansModel: _this.pickPlansModel, PickInfoResult: _this.PickInfoResult, pickPlansList: _this.pickPlansList, wellenNo: _this.wellenNo });
            }
        });
    };
    TakeawaypiecePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-takeawaypiece',template:/*ion-inline-start:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\takeawayhome\takeawaypiece\takeawaypiece.html"*/'<!--\n\n  Generated template for the TaskviewPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n  <ion-navbar color="wmscolor">\n\n    <ion-title>按件拣货\n\n      <!-- <div class="title_f_name">(青啤五厂)</div> -->\n\n    </ion-title>\n\n  </ion-navbar>\n\n  <ion-searchbar (keydown)="keyEnter($event)" debounce="1000" Description=\'primary\' [(ngModel)]="wellenNo"\n\n    placeholder="波次编码">\n\n  </ion-searchbar>\n\n  <div class="nav-tile">\n\n    <!-- <ul>\n\n      <li>首页</li>\n\n      <li>\n\n        <ion-icon class="iconfont iconicon_arr_right"></ion-icon>\n\n      </li>\n\n      <li>拣货</li>\n\n      <li>\n\n        <ion-icon class="iconfont iconicon_arr_right"></ion-icon>\n\n      </li>\n\n      <li>按件拣货</li>\n\n    </ul> -->\n\n    <crumbs></crumbs>\n\n  </div>\n\n</ion-header>\n\n<ion-content>\n\n</ion-content>'/*ion-inline-end:"D:\developer_tools\workspace\wms_3.0_base_pda\src\pages\takeawayhome\takeawaypiece\takeawaypiece.html"*/,
        }),
    ...
    return TakeawaypiecePage;
}());

//# sourceMappingURL=takeawaypiece.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TakeawaypiecePageModule", function() { return TakeawaypiecePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__takeawaypiece__ = __webpack_require__(1050);
...
var TakeawaypiecePageModule = /** @class */ (function () {
    function TakeawaypiecePageModule() {
    }
    TakeawaypiecePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__takeawaypiece__["a" /* TakeawaypiecePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__takeawaypiece__["a" /* TakeawaypiecePage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_crumbs_crumbs_module__["a" /* CrumbsModule */]
            ],
            schemas: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["NO_ERRORS_SCHEMA"]]
        })
    ], TakeawaypiecePageModule);
    return TakeawaypiecePageModule;
}());

//# sourceMappingURL=takeawaypiece.module.js.map
