...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PutawayboxPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_Utils__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_SkuLotModel__ = __webpack_require__(158);
 ...
 */
var PutawayboxPage = /** @class */ (function () {
    function PutawayboxPage(navCtrl, navParams, nativeService, appService, barcodeService, modalCtrl, events, ngZone) {
        var _this = this;
        ...
        this.events = events;
        this.ngZone = ngZone;
        this.skuLotModel = new __WEBPACK_IMPORTED_MODULE_3__models_SkuLotModel__["a" /* SkuLotModel */](); //批属性对象
        this.items = [];
        /**界面实体 */
        this.lpnCode = ''; //容器编码
        this.zoneCode = ''; //库区编码
        ...
        this.locCode = 'STAGE'; //当前库位
        this.targetlocCode = ''; //目标库位
        this.recommendLoc = ''; //推荐库位
        ...
        this.appService.httpRequest(__WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["b" /* Api */].api + __WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["b" /* Api */].ApiPDA, __WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["f" /* Method */].Post, '', __WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["e" /* ContenType */].Form, function (result) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isNotEmpty(result.data)) {
                _this.WarehouserModel = result.data;
                _this.warhouserItem = result.data[0];
            }
        });
    }
    PutawayboxPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        //事件注册（扫描结果接收）
    ...
    PutawayboxPage.prototype.ionViewWillLeave = function () {
     ...
     *
     */
    PutawayboxPage.prototype.scanModelChange = function (event) {
        if (event && event.keyCode == 13) {
            this.getStockInfoPutawayForBox(this.searchCode);
        }
    };
    /*物品扫描*/
    PutawayboxPage.prototype.scanWmsSku = function (val) {
        var _this = this;
        ...
        this.appService.httpRequest(__WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["b" /* Api */].api + __WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["b" /* Api */].SkuList, __WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["f" /* Method */].Post, params, __WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["e" /* ContenType */].Json, function (result) {
            //判断是否多个物品
   ...
   *查看物品明细
  */
    PutawayboxPage.prototype.openAsnRecordModal = function (skuList, val) {
        var _this = this;
     ...
     * 箱码解析
     */
    PutawayboxPage.prototype.getStockInfoPutawayForBox = function (searchCode) {
        var _this = this;
        if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isEmpty(this.warhouserItem)) {
            this.nativeService.showToast('请选择仓库');
            return;
        }
        if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isEmpty(searchCode)) {
        ...
        this.planCount = '';
        this.scanModel = null;
        this.barcodeService.ScanSkuBarcode(searchCode).subscribe(function (val) {
    ...
    /**
      * 查询库存信息
    */
    PutawayboxPage.prototype.islocCode_KeyDown = function (model) {
        var _this = this;
        ...
        this.appService.httpRequest(__WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["b" /* Api */].Instock + __WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["b" /* Api */].getStockInfoPutawayForBox, __WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["f" /* Method */].Post, param, __WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["e" /* ContenType */].Json, function (result) {
            if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isNotEmpty(result.data)) {
                var Jsonresult_1 = result.data;
                _this.zoneName = Jsonresult_1.zoneName;
                _this.zoneCode = Jsonresult_1.zoneCode;
                _this.typeCount = Jsonresult_1.typeCount;
                _this.locStatusName = Jsonresult_1.locStatusName;
                _this.whName = Jsonresult_1.whName;
                _this.planCount = Jsonresult_1.planCount;
                //this.locCode = Jsonresult.locCode;
                _this.whId = Jsonresult_1.whId;
                _this.items = Jsonresult_1.stockLocList;
                if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isNotEmpty(Jsonresult_1.targetLocCode)) {
                    _this.ngZone.run(function () {
                        _this.recommendLoc = Jsonresult_1.targetLocCode;
                        _this.nativeService.hideLoading();
                    });
                }
                else {
                ...
                _this.stockId = Jsonresult_1.stockId;
            }
        });
    };
    /**
     * 上架提交
     */
    PutawayboxPage.prototype.btnOk = function () {
        var _this = this;
        if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isEmpty(this.stockId)) {
            this.nativeService.showToast('没有查询到库存信息');
            return;
        }
        if (__WEBPACK_IMPORTED_MODULE_2__services_Utils__["a" /* Utils */].isEmpty(this.scanModel)) {
            this.nativeService.showToast('物品不能为空');
            return;
        }
        var param = {
        ...
        this.nativeService.showLoading();
        this.appService.httpRequest(__WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["b" /* Api */].Instock + __WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["b" /* Api */].submitPutawayForBox, __WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["f" /* Method */].Post, param, __WEBPACK_IMPORTED_MODULE_4__utils_appConstant__["e" /* ContenType */].Json, function (result) {
   ...
   * 返回
   */
    PutawayboxPage.prototype.exit = function () {
        // console.log(this.locCode);
        this.navCtrl.pop();
    };
    PutawayboxPage.prototype.clearModel = function () {
        this.skuLotModel = new __WEBPACK_IMPORTED_MODULE_3__models_SkuLotModel__["a" /* SkuLotModel */](); //批属性对象
        this.skuCode = '';
        this.skuName = ''; //物品名称
        this.scanQty = null; //数量
        this.wsuName = ''; //计量单位名称
        this.instockDate = null; //入库日期
        this.produceDate = null; //日期(生产日期)
        this.typeCode = ''; //物品类型编码
        this.lotNumber = ''; //批次号
        this.version = ''; //版本号
        this.remarks = ''; //备注
        this.type = ''; //类型
        this.labelCode = ''; //标签类型名称
        this.labelType = ''; //标签类型
        this.labelValue = ''; //标签内容
        this.searchCode = ''; //二维码内容
        /**界面实体 */
        this.lpnCode = ''; //容器编码
        this.zoneCode = ''; //库区编码
        this.zoneName = ''; //库区名称
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PutawayboxPageModule", function() { return PutawayboxPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__putawaybox__ = __webpack_require__(1362);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_primeng_dropdown__ = __webpack_require__(822);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_primeng_dropdown___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_primeng_dropdown__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_primeng_calendar__ = __webpack_require__(810);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_primeng_calendar___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_primeng_calendar__);
...
var PutawayboxPageModule = /** @class */ (function () {
    function PutawayboxPageModule() {
    }
    PutawayboxPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__putawaybox__["a" /* PutawayboxPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_3_primeng_dropdown__["DropdownModule"],
                __WEBPACK_IMPORTED_MODULE_4_primeng_calendar__["CalendarModule"],
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__putawaybox__["a" /* PutawayboxPage */]),
                __WEBPACK_IMPORTED_MODULE_5__components_crumbs_crumbs_module__["a" /* CrumbsModule */]
            ],
            schemas: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["NO_ERRORS_SCHEMA"]]
        })
    ], PutawayboxPageModule);
    return PutawayboxPageModule;
}());

//# sourceMappingURL=putawaybox.module.js.map
