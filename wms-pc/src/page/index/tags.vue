        ...
        <div class="avue-tags__box"
            ...
            <el-dropdown class="avue-tags__menu">
                ...
                <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item @click.native="$parent.isSearch=true">{{ $t('tagsView.search') }}
                    </el-dropdown-item>
                    <el-dropdown-item @click.native="closeOthersTags">{{ $t('tagsView.closeOthers') }}
                    </el-dropdown-item>
...
export default {
    ...
    computed: {
        ...
        showClose() {
            return this.tag.value != this.tagWel.value;
        }
    },
    methods: {
        generateTitle(item) {
