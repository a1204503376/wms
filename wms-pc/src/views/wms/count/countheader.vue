        ...
        <span class="dropdownPanel">
          <el-dropdown @command="handleCommand" trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="1" v-if="permission.count_header_completeTask">完成盘点</el-dropdown-item>
              <el-dropdown-item command="2" v-if="permission.count_header_repeat">复盘</el-dropdown-item>
              <el-dropdown-item command="3" v-if="permission.count_header_abolish">盘点作废</el-dropdown-item>
              <el-dropdown-item command="4" v-if="permission.count_header_differenceReport">生成差异报告</el-dropdown-item>
              <el-dropdown-item command="6" v-if="permission.count_header_differenceOrder">创建差异单据</el-dropdown-item>
              <el-dropdown-item command="5" divided v-if="permission.count_header_randomTask">随机盘点</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </span>
            </template>
