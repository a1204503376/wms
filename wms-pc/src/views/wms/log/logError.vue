        ...
        <nodes-master-page :showExpandBtn="false" v-on="form.events">
                ...
                <el-row type="flex">
                    <el-col :span="6">
                        <el-form-item label="操作方式" label-width="90px">
                            <el-input placeholder="请输入操作方式" v-model.trim="form.params.method" :clearable="true"
                                      class="search-input">
                            </el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="请求url" label-width="90px">
                            <el-input placeholder="请输入url" v-model.trim="form.params.requestUri" :clearable="true"
                                      class="search-input">
                            </el-input>
                        </el-form-item>
                    </el-col>
            ...
            <template v-slot:table>
                <el-table ref="table" :data="table.data" :height="height" border highlight-current-row
                          row-key="receiveId" size="mini" @sort-change="onSortChange">
