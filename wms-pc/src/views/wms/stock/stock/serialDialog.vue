<template>
    <el-dialog
        ...
        >
            ...
            <el-table-column property="whName" label="库房" width="160" show-overflow-tooltip></el-table-column>
            <el-table-column property="serialNumber" label="序列号" width="160" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column property="lotNumber" label="批次号" width="160" show-overflow-tooltip></el-table-column>
            <el-table-column property="systemProcId" label="系统日志" show-overflow-tooltip></el-table-column>
        </el-table>
...
<script>
    import {getPage} from "@/api/wms/core/serial.js";
