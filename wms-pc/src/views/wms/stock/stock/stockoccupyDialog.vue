<template>
    ...
    >
        ...
        >
            ...
            <!-- <el-table-column property="transId" label="事务ID" width="160" show-overflow-tooltip></el-table-column> -->
            <el-table-column property="occupyTypeName" label="占用类型" width="160" show-overflow-tooltip></el-table-column>
            <el-table-column property="whName" label="库房名称" width="160" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column property="occupyTime" label="占用开始时间" width="160" show-overflow-tooltip></el-table-column>
            <el-table-column property="occupyQty" label="占用数量" width="160" show-overflow-tooltip></el-table-column>
...
<script>
    import {getList} from "@/api/wms/core/stockoccupy.js";
