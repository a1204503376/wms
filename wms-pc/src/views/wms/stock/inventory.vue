    ...
    <div id='inventory'>
        <nodes-master-page v-on="form.events">
                ...
                <el-row class="search-elRow" type="flex">
                    ...
                    <el-col :span="6">
                        <el-form-item label="生产批次" label-width="90px">
                            <el-input
                                :clearable="true" class="search-input" placeholder="请输入生产批次"
                ...
                <el-row class="search-elRow" type="flex">
                    <el-col :span="6">
                        <el-form-item label="库区" label-width="90px">
                            <nodes-zone
                                :multiple="true"
                                class="search-input" v-model="form.params.zoneIdList">
                            </nodes-zone>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="箱号" label-width="90px">
                            <el-input
                                :clearable="true"
                                class="search-input" placeholder="请输入箱号"
                    ...
                    <el-col :span="6">
                        <el-form-item label="规格型号" label-width="90px">
                            <el-input
                                :clearable="true" class="search-input" placeholder="请输入规格型号"
                ...
                <el-row class="search-elRow" type="flex">
                    ...
                    <el-col :span="6">
                        <el-form-item label="专用客户" label-width="90px">
                            <el-input
                                :clearable="true" class="search-input" placeholder="请输入专用客户"
                    ...
                    <el-col :span="6">
                        <el-form-item label="钢背批次" label-width="90px">
                            <el-input
                                :clearable="true"
                                class="search-input" placeholder="请输入钢背批次"
                    ...
                    <el-col :span="6">
                        <el-form-item label="摩擦块批次" label-width="90px">
                            <el-input
                                :clearable="true"
                                class="search-input" placeholder="请输入摩擦块批次"
                ...
                <el-row class="search-elRow" type="flex">
                    <el-col :span="6">
                        <el-form-item label="库房" label-width="90px">
                            <nodes-warehouse
                                :multiple="true"
                                class="search-input" v-model="form.params.whIdList">
                            </nodes-warehouse>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                    ...
                    <el-col :span="6">
                        <el-form-item label="货架列" label-width="90px">
                            <el-input
                                class="search-input"
                                placeholder="请输入货架列" v-model="form.params.locColumn">
                            </el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="库区类型" label-width="90px">
                            <nodes-dictionary
                                ...
                                :multiple="true"
                                class="search-input"
                                code="zone_type" v-model="form.params.zoneTypeList">
                            </nodes-dictionary>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row type="flex">
                    ...
                    <el-col :span="6">
                        <el-form-item label="批次号" label-width="90px">
                            <el-input
                                :clearable="true" style="width: 42%;"
                                v-model.trim="form.params.lotNumberBegin">
                            </el-input>
                            -
                            <el-input
                                :clearable="true" style="width: 42%;"
                                v-model.trim="form.params.lotNumberEnd">
                            </el-input>
            ...
            <template v-slot:batchBtn>
                ...
                <el-button @click="onUpload" icon="el-icon-upload2" plain size="mini"
                           v-if="permissionObj.upload">导入
                </el-button>
                <file-upload
                    ...
                    <template v-for="(column, index) in table.columnList">
                        <el-table-column
                            ...
                            <template v-if="column.prop === 'hasSerial' ||
                                ...
                                <el-link
                                    :underline="false"
                                    @click="showHasSerialView(scope.row.stockId)"
                                    target="_blank"
                                    type="primary"
                ...
                <div style="margin-top: 10px;">
                    ...
                    <el-table
                        ...
                        <el-table-column
                            ...
                            <template v-slot="scope">
                                <el-input-number
                                    :max="dialog.children.max"
                                    :min="dialog.children.min" @change="qtyChange(scope.row)"
                                    size="medium"
                                    style="width: 100%" v-model="scope.row['qty']">
                                </el-input-number>
                            </template>
                        </el-table-column>
                        <el-table-column
                        ...
                        <el-table-column
                            ...
                            <template v-slot="scope">
                                <el-button
                                    @click="dialogHandleRemove(scope.$index, scope.row)"
                                    size="mini"
                                    type="danger">删除
                                </el-button>
                            </template>
