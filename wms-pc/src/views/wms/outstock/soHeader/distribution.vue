    ...
    <basic-container>
                            ...
                            <el-tabs>
                                <el-tab-pane label="发货明细">
                                    <el-table :data="table.soDetailData" :height="table.soDetailHeight"
                                        :show-summary="true" :summary-method="summarySoDetail" @row-click="onRowClick"
                                        border highlight-current-row ref="table" size="mini">
                                ...
                                <el-tabs type="border-card">
                                    <el-tab-pane label="分配记录">
                                        <el-table :data="table.soPickPlanData" :height="table.soPickPlanHeight"
                                            ...
                                            :summary-method="summarySoPickPlan" border highlight-current-row
        ...
        <el-dialog :append-to-body="true" :close-on-click-modal="false" :fullscreen="true" :show-close="true"
            ...
            <el-table :data="dialog.dialogData" :height="dialog.dialogTableHeight" :span-method="objectSpanMethod"
                :summary-method="getSummaries" border highlight-current-row ref="dialogTable" show-summary>
            ...
            <el-dialog :append-to-body="true" :title="innerDialog.title" :visible.sync="innerDialog.showInnerDialog"
                ...
                <el-table :data="innerDialog.tableData" :height="innerDialog.tableHeight" :summary-method="getSummaries"
                    border highlight-current-row ref="dialogTable" show-overflow-tooltip show-summary>
...
export default {
    ...
    methods: {
        ...
        async onAdjust(row) {
            ...
            await getStockByDistributeAdjust(row.skuId, row.skuLot1, row.skuSpec, row.skuLot4, this.soHeader.soBillId)
                .then((res) => {
            ...
            await getStockAgvAndPick(row.skuId, row.skuLot1, row.skuSpec, row.skuLot4, this.soHeader.soBillId)
                .then((res) => {
