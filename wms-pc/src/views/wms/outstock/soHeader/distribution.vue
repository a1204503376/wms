    ...
    <basic-container>
                        ...
                        <el-col>
                            <el-tabs>
                                <el-tab-pane label="发货明细">
                                    <el-table ref="table" :data="table.soDetailData"
        ...
        <el-dialog :append-to-body="true" :close-on-click-modal="false" :fullscreen="true" :show-close="true"
                ...
                <el-table-column
                    ...
                    <template v-slot="{row}">
                        <el-link
                            ...
                            target="_blank"
                            type="primary"
                            @click="onShowBoxStock(row)">{{ row.boxCode }}
                        </el-link>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="库位" prop="locCode" width="120">
                    <template v-slot="{row}">
                        <el-link
                            ...
                            target="_blank"
                            type="primary"
                            @click="onShowLocStock(row)">{{ row.locCode }}
                        </el-link>
                    </template>
                </el-table-column>
            ...
            <el-dialog
                ...
                :visible.sync="innerDialog.showInnerDialog"
                width="80%">
                <el-table
                    ref="dialogTable"
                    :data="innerDialog.tableData"
                    :height="innerDialog.tableHeight"
...
export default {
    ...
    methods: {
        ...
        async onAdjust(row) {
            ...
            await getStockAgvAndPick(row.skuId, row.skuLot1, row.skuLot4, this.soHeader.soBillId)
                .then((res) => {
