                    ...
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="库房" >
                                 <nodes-warehouse v-model="form.params.newReceiveHeaderRequest.whId"></nodes-warehouse>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                        ...
                        <el-col :span="8">
                            <el-form-item label="供应商">
                                <nodes-supplier v-model="form.params.newReceiveHeaderRequest.supplierId" style="width: 200px"></nodes-supplier>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        ...
                        <el-col>
                            <el-table
                                ...
                                >
                                    ...
                                    <template v-slot="{row}">
                                        <nodes-sku-um v-model="row.umCode"  :sku-id="row.skuId"></nodes-sku-um>
                                    </template>
                                </el-table-column>
