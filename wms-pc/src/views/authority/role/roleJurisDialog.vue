...
<script>
import {grantTree, grant, getRole} from "@/api/authority/role";
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            grant(ids, menuList, dataScopeList, apiScopeList).then(() => {
        ...
        handleCheckAllChange() {
            ...
            if (this.dataScopeCheck) {
                this.$refs.dataScopeGrantList.setCheckedNodes([]);
                this.dataScopeCheck = false;
            } else {
                this.$refs.dataScopeGrantList.setCheckedNodes(this.dataScopeGrantList);
                this.dataScopeCheck = true;
            }
            if (this.apiCheck) {
                this.$refs.apiScopeGrantList.setCheckedNodes([]);
                this.apiCheck = false;
            } else {
                this.$refs.apiScopeGrantList.setCheckedNodes(this.apiScopeGrantList);
                this.apiCheck = true;
            }
        }
    },
