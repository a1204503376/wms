package org.nodes.wms.core.instock.inventory.entity;
...
@ApiModel(value = "AsnInventory对象", description = "收货清单头表")
public class AsnInventory extends AttributeBase implements Serializable {
