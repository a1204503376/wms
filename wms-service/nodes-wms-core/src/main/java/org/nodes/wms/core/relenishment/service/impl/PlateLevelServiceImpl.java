...
@Primary
public class PlateLevelServiceImpl extends AbsLevelServiceImpl {
	@Override
...
//			.groupBy(Stock::getLpnCode)
			.having(String.format("sum(stock_qty) >= %s",skuPackageDetail1.getConvertQty()));
		...
		relDetail.setSkuLevel(SkuLevelEnum.Plate.getIndex());
